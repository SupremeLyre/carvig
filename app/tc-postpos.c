/*-----------------------------------------------------------------------------
* tc-postpos.c : ins-gnss tightly coupled pose-pos app.
*
...
int main(int argc, char **argv)
{
    ...
    /* tightly coupled */
    if (!tcpostpos(&prcopt,&solopt,port,strpath[7],infile,strfmt[4])) {
